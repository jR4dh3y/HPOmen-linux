...
│       ├── overview_section.vala # System info cards
...
- Only later did I inspect the live probe snapshot and confirmed the machine actually exposed `can_set_profile=true` and `can_set_fan_mode=true`.
